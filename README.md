...
- Сезонные цены
- Модерация отзывов (одобрение с комментарием для гостя или отклонение с email-уведомлением гостя и директора)
- Автоматическое уведомление директора по почте, если бронирование или отзыв остаётся в статусе «ожидает» больше суток
- Новости и акции
- Дополнительные услуги
- Галерея
