...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #e74c3c; color: white; padding: 4px 12px; border-radius: 20px; font-size: 14px; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="content">
        ...
        <div class="details">
            <table>
                <tr>
                    <td>Номер комнаты:</td>
                    <td><strong>№{{ $booking->room->number }} ({{ $booking->room->roomType->name }})</strong></td>
                </tr>
                <tr>
                    <td>Дата заезда:</td>
