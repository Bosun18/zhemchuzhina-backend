...
<head>
    ...
    <style>
        ...
        .review-box { background: white; border-left: 4px solid #f39c12; padding: 15px; margin: 15px 0; border-radius: 0 6px 6px 0; }
...
<body>
    ...
    <div class="content">
        <p>Отзыв <span class="badge">⏳ Ожидает подтверждения больше суток</span></p>
